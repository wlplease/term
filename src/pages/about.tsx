  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-gray-900 text-white">
        <main className="flex-grow container mx-auto p-8 bg-black text-green-400 font-mono shadow-lg rounded-md">
          <h1 className="text-3xl font-bold mb-6">About NullShift</h1>

          <p className="mb-4">
            Welcome to the NullShift Crew! Our community thrives on
            blockchain-powered innovation, learning, and on-chain fun.
          </p>

          <h2 className="text-2xl font-semibold mb-4">The $J3FF3R NFT Club</h2>
          <p className="mb-4">
            The $J3FF3R NFT Club is a collection of NFTs designed for
            blockchain enthusiasts seeking an exclusive on-chain learning and
            experimental experience. Holding a $J3FF3R NFT grants you access
            to:
          </p>
          ...
          <p className="mb-4">
            The $J3FF3R ecosystem is focused entirely on learning, community,
            and exploration. There are:
          </p>
          <ul className="list-disc list-inside mb-4">
          ...
          <p className="mb-4">
            The $J3FF3R community collectively owns and controls the future of
            the ecosystem, including all liquidity, if the community decides
            to add it. There is:
          </p>
          <ul className="list-disc list-inside mb-4">
          ...
          <div className="mt-6 text-center">
            <Link href="/connect" className="hover:underline text-yellow-400">
              Ready to join the crew? Mint your $J3FF3R NFT now!
            </Link>
          </div>

          <div className="mt-6 text-center space-y-4">
            <Link href="/disclaimer" className="hover:underline text-blue-400">
              Read our Disclaimer
            </Link>
            <br />
            <Link href="/terms" className="hover:underline text-blue-400">
