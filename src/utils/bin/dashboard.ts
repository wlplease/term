   ...
   @@             @@@@@@          @@         <u><a href="https://linkedin.com/in/${config.social.linkedin || ''}" target="_blank" rel="noopener noreferrer">linkedin.com/in/${config.social.linkedin || ''}</a></u>
     @@@                        @@@         -----------
        @@@                  @@@ @@          DONATE 
         ...
         @|                      @@          CashApp: <u><a href="https://cash.app/${config.donate_urls.cashapp}" target="_blank" rel="noopener noreferrer">${config.donate_urls.cashapp}</a></u>
         @|                      @@          Ethereum: <u><a href="https://etherscan.io/address/${config.donate_urls.ethereum}" target="_blank" rel="noopener noreferrer">${config.donate_urls.ethereum}</a></u>
`;
  } else {
